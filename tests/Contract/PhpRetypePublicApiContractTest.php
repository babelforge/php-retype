...
final class PhpRetypePublicApiContractTest extends TestCase
{
    ...
    public function testItExposesTheExpectedFacadeMethods(): void
    {
        self::assertSame([
            ...
            'changePropertyType',
            'executeStep',
            'executeStepArrowFunctionParameterTypeInFile',
            'executeStepArrowFunctionParameterTypeInFunction',
            'executeStepArrowFunctionParameterTypeInMethod',
            'executeStepArrowFunctionReturnTypeInFile',
            'executeStepArrowFunctionReturnTypeInFunction',
            'executeStepArrowFunctionReturnTypeInMethod',
            'executeStepClassConstantTypeChange',
            'executeStepClosureParameterTypeInFile',
            'executeStepClosureParameterTypeInFunction',
            'executeStepClosureParameterTypeInMethod',
            'executeStepClosureReturnTypeInFile',
            'executeStepClosureReturnTypeInFunction',
            ...
            'fromBuild',
            'fromDirectory',
            'planArrowFunctionParameterTypeInFile',
            'planArrowFunctionParameterTypeInFunction',
            'planArrowFunctionParameterTypeInMethod',
            'planArrowFunctionReturnTypeInFile',
            'planArrowFunctionReturnTypeInFunction',
            'planArrowFunctionReturnTypeInMethod',
            'planClassConstantTypeChange',
            'planClosureParameterTypeInFile',
            'planClosureParameterTypeInFunction',
            'planClosureParameterTypeInMethod',
            'planClosureReturnTypeInFile',
            'planClosureReturnTypeInFunction',
