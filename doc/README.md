...
The package currently supports planning and applying method and function parameter type changes. It keeps native PHP type nodes and PHPDoc type strings as two explicit caller-provided values.
